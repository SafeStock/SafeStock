...
public class ProdutoMapper {
    ...
    public static Produto toDomain(ProdutoEntity entity) {
        ...
        // Mapeia a creche sem seus produtos para evitar loop infinito
        if (entity.getCreche() != null) {
            produto.setCreche(CrecheMapper.toDomainSimple(entity.getCreche()));
        }
    ...
    public static ProdutoEntity toEntity(Produto produto) {
        ...
        if (produto.getCreche() != null) {
            entity.setCreche(CrecheMapper.toEntity(produto.getCreche()));
        }
