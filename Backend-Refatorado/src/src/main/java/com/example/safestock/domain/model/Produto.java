...
public class Produto {
    ...
    public Produto(Long id, String nome, CategoriaProduto categoriaProduto, int quantidade, int limiteSemanalDeUso, LocalDate dataValidade, LocalDateTime dataEntrada, Long aLong) {
        this.id = id;
        this.nome = nome;
        this.categoriaProduto = categoriaProduto;
        this.quantidade = quantidade;
