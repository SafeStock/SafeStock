...
public class CrecheMapper {
    ...
    // Versão simplificada que não mapeia produtos para evitar loop infinito
    public static Creche toDomainSimple(CrecheEntity e) {
        if (e == null) return null;
        Creche d = new Creche();
        d.setId(e.getId());
        d.setNome(e.getNome());
        ...
        // Não mapeia funcionários e produtos para evitar recursão
        return d;
    }
}