export function UserInformationDiv({
  ...
  return (
    <div>
      ...
      <div className="h-[12vh] w-[85vw] flex flex-row justify-center items-center shadow-[0_0_10px_rgba(0,0,0,0.5)] bg-white rounded-[20px]">
        <img src="/src/assets/UserIconAdded.svg" className="h-[6vh] w-[3vw] ml-[5vh] relative left-[-6vw]"/>
