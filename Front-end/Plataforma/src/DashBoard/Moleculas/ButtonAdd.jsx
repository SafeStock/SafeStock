...
export function ButtonAdd({ displayButton ="none" }) {
  ...
  return (
      <div className="w-[8vw] h-[8vh] items-center justify-center mt-[4vh] ml-[3vw]" style={{ display: displayButton }}>
        <button
          title="Cadastrar" onClick={() => handleRedirect('/dashboard/cadastro')}
