export function ExportInformationDiv ( { titulo = "Undefined" } ) {
    ...
    return(
        <div>
            ...
            <div className="flex justify-center items-center rounded-[1.5vw] w-[40vw] h-[9.5vh] shadow-[0_2px_5px_rgba(0,0,0,0.3)]">
                ...
                <div className=" flex justify-center items-center w-[2.5vw] h-[5vh] ml-[18.2vw] rounded-[0.9vw] border-[1.8px] cursor-pointer 
                border-transparent transition-colors duration-400 hover:border-[1.8px] hover:border-[#3A577B]">
