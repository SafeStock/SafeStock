...
import com.example.safestock.core.domain.*;
import com.example.safestock.core.dto.funcionario.*;
import com.example.safestock.core.dto.autenticacao.TokenDTO;
...
public class FuncionarioMapper {
    ...
    public static FuncionarioListar of(Funcionario funcionario) {
        ...
        funcionarioListar.setCargo(funcionario.getCargo());
        funcionarioListar.setTelefone(funcionario.getTelefone());
